...
namespace RoundedTB
{
    class Taskbar
    {
        ...
        /// <summary>
        /// Undo TaskbarAnimations=0 left by older fork builds (v13–v14 experiments).
        /// </summary>
        public static void RestoreExplorerTaskbarAnimations()
        {
            try
            {
                ...
                object cur = key.GetValue("TaskbarAnimations");
                if (cur is int i && i == 0)
                {
